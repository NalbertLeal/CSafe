...
int main(void) {
  ...
  HashNode* n1 = newHashNode("nalbert", "gabriel");
  HashNode* n2 = newHashNode("melo", "leal");
  HashNode* n4 = newHashNode("odin", "thor");
  ...
  // buscando elementos e printando os elementos encontrados

  HashNode* n3 = hashSearch(&ht, "odin");
  printf("%s -> %s \n", n3->key, n3->data);

  n3 = hashSearch(&ht, "melo");
  printf("%s -> %s \n", n3->key, n3->data);

  n3 = hashSearch(&ht, "nalbert");
  printf("%s -> %s \n", n3->key, n3->data);

  // removendo elemento e printando o elemento e removido

  n3 = hashRemove(&ht, "nalbert");
  printf("%s -> %s \n", n3->key, n3->data);
